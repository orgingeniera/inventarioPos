...
function enviar_frm()
{
  ...
  dataString+='&tipo_usuario='+tipo_usuario+'&idempleado='+idempleado+"&idPertenece="+pertenece_empleado;
     ...
     success: function(data){
        ...
        if(data=="Validado"){
             ...
             if(proceso=="Registro"){
              ...
              cargarDiv("#reload-div","web/ajax/reload-usuario.php?idPertenece="+pertenece_empleado);
              limpiarform();

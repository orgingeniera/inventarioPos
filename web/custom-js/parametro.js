...
function enviar_frm()
{
  ...
  dataString+='&porcentaje_retencion='+porcentaje_retencion+'&monto_retencion='+monto_retencion+"&idPertenece="+pertenece_empleado;
     ...
     success: function(data){
        ...
        if(data=="Validado"){
             ...
             if(proceso=="Registro"){
              ...
              cargarDiv("#reload-div","web/ajax/reload-parametro.php?idPertenece="+pertenece_empleado);
              limpiarform();

...
if($("#txtImagen").val() !=''){
  ...
  dataString+='&idmarca='+idmarca+'&idpresentacion='+idpresentacion+'&estado='+estado+'&exento='+exento+'&inventariable='+inventariable+'&perecedero='+perecedero+'&imagen='+imagen+'&cimagen='+cimagen;

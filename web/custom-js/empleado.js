...
if($("#txtImagen").val() !=''){
  ...
  dataString+='&telefono_empleado='+telefono_empleado+'&email_empleado='+email_empleado+'&imagen='+imagen+'&cimagen='+cimagen+"&idPertenece="+pertenece_empleado;
     ...
     success: function(data){
        ...
        if(data=="Validado"){
             ...
             if(proceso=="Registro"){
              ...
              cargarDiv("#reload-div","web/ajax/reload-empleado.php?idPertenece="+pertenece_empleado);
              limpiarform();

<?php
	...
	class ProductoModel extends Conexion
	{
		...
		$precio_venta_mayoreo,$stock,$stock_min,$idcategoria,$idmarca,$idpresentacion,$exento,$inventariable,$perecedero,$imagen)
		{
			$dbconec = Conexion::Conectar();
			try
			{
...
:precio_venta_mayoreo,:stock,:stock_min,:idcategoria,:idmarca,:idpresentacion,:exento,:inventariable, :perecedero, :imagen)";
		...
		public static function Editar_Producto($idproducto, $codigo_barra,$nombre_producto,$precio_compra,$precio_venta,$precio_venta_mayoreo,$stock_min, $idcategoria,$idmarca,$idpresentacion,$estado,$exento,$inventariable,$perecedero,$imagen,$cimagen)
		{
			$dbconec = Conexion::Conectar();
			try
			{
			function format_uri( $string, $separator = '-' )
				...
				:idcategoria,:idmarca,:idpresentacion,:estado,:exento,:inventariable,:perecedero,:imagen)";
				$stmt = $dbconec->prepare($query);
				$stmt->bindParam(":idproducto",$idproducto);
				$stmt->bindParam(":codigo_barra",$codigo_barra);
				$stmt->bindParam(":nombre_producto",$nombre_producto);

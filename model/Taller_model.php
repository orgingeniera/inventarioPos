...
SET numero_orden = :numero_orden, fecha_ingreso = :fecha_ingreso, idcliente = :idcliente, aparato = :aparato,
modelo = :modelo, idmarca = :idmarca, serie = :serie, idtecnico = :idtecnico,
averia = :averia, observaciones = :observaciones, deposito_revision = :deposito_revision, deposito_reparacion = :deposito_reparacion

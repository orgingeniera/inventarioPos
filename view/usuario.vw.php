...
<style>
	.label-purple {
    background-color: #6f42c1; /* morado elegante */
    color: #fff;
}
</style>
				...
				<div class="breadcrumb-line">
					...
					<table class="table datatable-basic table-xxs table-hover">
						...
						<tbody>
						  ...
						  <?php
								$filas = $objUsuario->Listar_Usuarios($idpertenece);
								...
								?>
									<tr>
					            		...
					            		<td><?php 
												switch ($column['tipo_usuario']) {
													case '1':
														echo '<span class="label label-warning label-rounded"><span class="text-bold">ADMINISTRADOR</span></span>';
														break;
													case '2':
														echo '<span class="label label-info label-rounded"><span class="text-bold">CAJA</span></span>';
														break;
													case '3':
														echo '<span class="label label-purple label-rounded"><span class="text-bold">SUPER ADMINISTRADOR</span></span>';
														break;
											...
											<div class="col-sm-12">
												...
												<select  data-placeholder="..." id="cbEmpleado" name="cbEmpleado"
				                            		...
				                            		onkeyup="javascript:this.value=this.value.toUpperCase();">
				                            			 <?php
															$filas = $objUsuario->Listar_Empleados($idpertenece);
															if (is_array($filas) || is_object($filas))
															{
															foreach ($filas as $row => $column)
															{
...
<script type="text/javascript" src="web/custom-js/usuario.js?v=1"></script>
<?php } else { ?>
